...
function webpackPluginServe(_a) {
    ...
    return {
        plugins: [
            new webpack_plugin_serve_1.WebpackPluginServe(tslib_1.__assign({ 
                // @ts-ignore: The types don't have the feature yet
                hmr: "refresh-on-failure", progress: "minimal", historyFallback: historyFallback, middleware: function (app) {
