...
var brotli_webpack_plugin_1 = tslib_1.__importDefault(
  require("brotli-webpack-plugin"),
);
var mini_css_extract_plugin_1 = tslib_1.__importDefault(
  require("mini-css-extract-plugin"),
);
var optimize_css_assets_webpack_plugin_1 = tslib_1.__importDefault(
  require("optimize-css-assets-webpack-plugin"),
);
var clean_webpack_plugin_1 = require("clean-webpack-plugin");
// @ts-ignore: Figure out how to type this
var webpack_plugin_1 = tslib_1.__importDefault(
  require("@packtracker/webpack-plugin"),
);
var webpack_bundle_tracker_1 = tslib_1.__importDefault(
  require("webpack-bundle-tracker"),
);
var terser_webpack_plugin_1 = tslib_1.__importDefault(
...
function mergeStorybook(_a) {
  ...
  newConfig.module.rules =
    (_b =
      userConfig === null || userConfig === void 0
        ? void 0
        : userConfig.module) === null || _b === void 0
      ? void 0
      : _b.rules;
  // @ts-ignore
  newConfig.resolve.extensions =
    (_c =
      userConfig === null || userConfig === void 0
        ? void 0
        : userConfig.resolve) === null || _c === void 0
      ? void 0
      : _c.extensions;
  // @ts-ignore
  newConfig.resolve.modules =
    (_d =
      userConfig === null || userConfig === void 0
        ? void 0
        : userConfig.resolve) === null || _d === void 0
      ? void 0
      : _d.modules;
  // @ts-ignore
  newConfig.node = tslib_1.__assign(
    tslib_1.__assign(
      {},
      newConfig === null || newConfig === void 0 ? void 0 : newConfig.node,
    ),
    userConfig === null || userConfig === void 0 ? void 0 : userConfig.node,
  );
  return newConfig;
}
...
function loadCSS(_a) {
  var _b = _a === void 0 ? {} : _a,
    mode = _b.mode,
    postCssPlugins = _b.postCssPlugins;
      ...
      rules: [
        ...
        },
        {
          ...
          use: {
            loader: "file-loader",
            options: tslib_1.__assign(
              { name: "[name].[ext]", mimetype: "application/octet-stream" },
              options,
            ),
          },
        },
      ...
      rules: [
        ...
        // Use inlining behavior (<15k -> inline) for css/less/scss
        {
          ...
          use: {
            loader: "url-loader",
            options: tslib_1.__assign(
              { limit: 15000, name: "[name].[ext]", mimetype: "image/svg+xml" },
              options,
            ),
          },
        },
...
function minifyJavaScript(_a) {
  var terserOptions = (_a === void 0 ? { terserOptions: {} } : _a)
    .terserOptions;
  return {
    optimization: {
      minimizer: [
        new terser_webpack_plugin_1.default({
          cache: true,
          parallel: true,
          terserOptions: tslib_1.__assign(tslib_1.__assign({}, terserOptions), {
            output: tslib_1.__assign(
              { comments: false },
...
function emitStats(_a) {
  var _b = _a.path,
    path = _b === void 0 ? __dirname : _b,
    filename = _a.filename,
    _c = _a.publicPath,
    publicPath = _c === void 0 ? "" : _c,
    _d = _a.logTime,
    logTime = _d === void 0 ? false : _d;
  return {
    plugins: [
      new webpack_bundle_tracker_1.default({
        path: path,
        filename: filename,
