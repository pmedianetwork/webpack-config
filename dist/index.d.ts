...
declare function loadJavaScript({
  include,
  exclude,
}?: {
...
declare function loadImages(
  options?: FileLoaderOptions,
  svgLoader?: string,
): webpack.Configuration;
declare function dontParse(
  paths: webpack.Module["noParse"],
): webpack.Configuration;
...
declare function cleanOutput(
  options?: CleanWebpackPluginOptions,
): webpack.Configuration;
declare function emitStats({
  path,
  filename,
  publicPath,
  logTime,
...
declare function exposeEnvironmentVariables(
...
declare function exposeGlobals(
  globals: {
    module: string;
    global: string;
  }[],
): webpack.Configuration;
declare function compressWithBrotli(
